        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="page-back"><a href="{{url('/')}}/admin/addCaseStudy"><i class="fa fa-pencil" aria-hidden="true"></i> All Projects</a>
                    </li>
                </ul>
            </div>
            <div class="sb2-2-1">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{url('/')}}/admin/editCaseStudies/{{$item->id}}" class="sb2-2-1-edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            </td>
                            ...
                            function archiveFunction{{$item->id}}()
                                {
                                    ...
                                    swal({
                                        ...
                                        if (willDelete) {
                                            //do the ajax stuff.
                                            $.ajax({
                                                url: "{{url('/')}}/admin/deleteCaseStudiesAjax",
