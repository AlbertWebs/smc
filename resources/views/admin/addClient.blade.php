        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="page-back"><a href="{{url('/')}}/admin/banners"><i class="fa fa-backward" aria-hidden="true"></i> All Client</a>
                    </li>
                </ul>
                ...
                <form method="POST" action="{{url('/')}}/admin/add_Client" enctype="multipart/form-data">
                    ...
                    <div class="input-field col s12">
                        <select required name="type" class="icons" id="mydiv">
                            <option value="partner" selected  class="circle">Partner</option>
