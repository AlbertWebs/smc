					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="text-dark text-10"><strong>Career Inquiry</strong></h1>
								<span class="sub-title text-dark">We're always looking for rockstars, Leave your inquiry with us, we will get back to you soonest possible</span>
							</div>
						...
						<div class="row pb-4">
							<div class="col-md-12">
								...
								<div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="200">
									<h4 class="mt-2 mb-2"> <strong>Careers Inquiry</strong></h4>
                                                    ...
                                                    <form class="contact-form" action="{{url('/')}}/apply-career" method="POST"  enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col">
                                                                ...
                                                                <input type="text" value="Application For " data-msg-required="Please enter the subject." maxlength="100" class="form-control text-3 h-auto py-2" name="subject" required>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="form-group col">
