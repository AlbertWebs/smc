...
<html data-style-switcher-options="{'colorPrimary': '#0088cc', 'colorSecondary': '#0169fe', 'colorTertiary': '#005AEF', 'colorQuaternary': '#383f48'}" lang="en">
    ...
    <head>
		...
		<!-- Web Fonts  -->
		<link id="googleFonts" href="../../../../fonts.googleapis.com/cssd3cc.css?family=Poppins:300,400,500,600,700,800%7COpen+Sans:400,700,800&amp;display=swap" rel="stylesheet" type="text/css">
		...
		<!-- Demo CSS -->
		<link rel="stylesheet" href="{{asset('theme/css/demos/demo-landing.css')}}">

		<!-- Skin CSS -->
		<link id="skinCSS" rel="stylesheet" href="{{asset('theme/css/skins/skin-landing.css')}}">
...
<script>
  ...
  gtag('config', 'G-CR14M1Q1LJ');
        ...
        <script type="text/javascript">
            ...
            s1.async=true;
            s1.src='https://embed.tawk.to/61f8d8cc9bd1f31184da51b6/1fqq0to1l';
            s1.charset='UTF-8';
	...
	<script defer src="../../../../static.cloudflareinsights.com/beacon.min.js" data-cf-beacon='{"rayId":"6a205b9d5ca2ac3a","version":"2021.10.0","r":1,"token":"03fa3b9eb60b49789931c4694c153f9b","si":100}'></script>
    <!-- Default Statcounter code for Sasema management Company
https://sasemagroup.com/g-analytics -->
<script type="text/javascript">
    var sc_project=12713521;
    var sc_invisible=1;
    var sc_security="87011fb3";
    </script>
    <script type="text/javascript"
    ...
    class="statcounter"
    src="https://c.statcounter.com/12713521/0/87011fb3/1/"
    alt="Web Analytics"
