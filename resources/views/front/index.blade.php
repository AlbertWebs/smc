					...
					<div class="header-column">
						<div class="header-row">
							<div class="header-logo">
								<a href="index.html"><img alt="Porto" width="100" height="48" data-sticky-width="82" data-sticky-height="40" data-sticky-top="0" src="{{asset('theme/img/logo-default-slim-dark.png')}}"></a>
							</div>
						</div>
					</div>
						...
						<div id="popup-content-1" class="dialog dialog-lg zoom-anim-dialog rounded p-3 mfp-hide mfp-close-out">
							<div class="ratio ratio-4x3">
								<video id="popupPresentation" class="float-start" width="100%" height="100%" muted playsinline loop preload="metadata" poster="video/presentation.jpg">
									  <source src="{{asset('theme/video/presentation.webm')}}" type="video/webm">
									  <source src="{{asset('theme/video/presentation.mp4')}}" type="video/mp4">
								</video>
							</div>
						</div>
					</div>
